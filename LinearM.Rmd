...
The greater the ARM force ,the greater the SIMS score increase meaning the correlate together which the scatter plot looks like a  linear  is trending up which is a sign a for a postive correlated data.
